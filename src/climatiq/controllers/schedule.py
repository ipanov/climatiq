...
DEFAULT_SCHEDULE: list[ScheduleEntry] = [
    ...
    ScheduleEntry(
        season=Season.WINTER,
        period=TimePeriod.LATE_MORNING,
        temperature_target=21.0,
        humidity_target=35.0,
    ),
    ScheduleEntry(
        season=Season.WINTER,
        period=TimePeriod.EARLY_AFTERNOON,
        temperature_target=21.0,
        humidity_target=35.0,
    ),
    ScheduleEntry(
        season=Season.WINTER,
        period=TimePeriod.LATE_AFTERNOON,
        temperature_target=21.0,
        humidity_target=35.0,
    ),
    ScheduleEntry(
    ...
    ScheduleEntry(
        season=Season.WINTER, period=TimePeriod.NIGHT, temperature_target=20.0, humidity_target=40.0
    ),
    # Summer
    ScheduleEntry(
    ...
    ScheduleEntry(
        season=Season.SUMMER, period=TimePeriod.NIGHT, temperature_target=23.0, humidity_target=50.0
    ),
    # Spring (transitional)
    ScheduleEntry(
    ...
    ScheduleEntry(
        season=Season.SPRING, period=TimePeriod.NIGHT, temperature_target=21.0, humidity_target=45.0
    ),
    ...
    ScheduleEntry(
        season=Season.AUTUMN, period=TimePeriod.NIGHT, temperature_target=21.0, humidity_target=45.0
    ),
]
...
class ScheduleController:
    ...
    def get_target(self, season: Season, period: TimePeriod) -> ScheduleEntry:
        ...
        return ScheduleEntry(
            season=season, period=period, temperature_target=23.0, humidity_target=45.0
        )
